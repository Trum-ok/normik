...
Принимает `.tex` и выдаёт список нарушений с указанием файла, строки и того,
кто этого требует: пункт стандарта, положение вуза либо ничего — типографику
стандарты не регулируют. Стандарт задаётся профилем — перечень поддержанных
на странице
