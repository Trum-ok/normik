...
#: Обозначения приложений по умолчанию: прописные буквы кириллицы, кроме исключённых
#: стандартом. Набор задаётся профилем: у другого источника требований он свой.
DEFAULT_APPENDIX_LETTERS = "АБВГДЕЖИКЛМНПРСТУФХЦШЩЭЮЯ"
