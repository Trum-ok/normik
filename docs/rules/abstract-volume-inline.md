...
| Пункты | ГОСТ 7.32-2017 п. 6.12.1 |
...
| Фикстуры | `tests/fixtures/abstract-volume-inline/` |
| Автоисправление | нет |
...
```toml
disable = ["abstract-volume-inline"]

[rules."abstract-volume-inline"]
severity = "info"
```
