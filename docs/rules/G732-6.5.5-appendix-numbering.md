# G732-6.5.5-appendix-numbering

**Иллюстрация приложения нумеруется без его обозначения.**

| | |
|---|---|
| Пункт ГОСТ 7.32-2017 | 6.5.5 |
| Уровень по умолчанию | `error` |
| Объявлено в | `nk.rules.elements.appendix_figure_numbering` |
| Фикстуры | `tests/fixtures/G732-6.5.5-appendix-numbering/` |
| Автоисправление | нет |
...
```toml
disable = ["G732-6.5.5-appendix-numbering"]

[rules."G732-6.5.5-appendix-numbering"]
severity = "info"
```
