...
таблицы — под другим стандартом не проверяется. Требование универсальное —
типографика — работает под любым, и пункт, если он у какого-то стандарта есть,
только уточняет источник находки.

Источником требований бывает и положение вуза — со своей нумерацией пунктов
и своими отступлениями от стандарта. Оно тоже описывается профилем.
